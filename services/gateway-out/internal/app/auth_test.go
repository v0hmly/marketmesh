...
func TestAuthRoutesUseOnlyPrivateTypedMutations(t *testing.T) {
	...
	want := map[contractv1.RouteId]string{
		...
		contractv1.RouteId_ROUTE_ID_AUTH_START_RECOVERY_CODES:       authv1.AuthBrowserService_BrowserStartRecoveryCodes_FullMethodName,
		...
		contractv1.RouteId_ROUTE_ID_AUTH_COMPLETE_RECOVERY_CODES:    authv1.AuthBrowserService_BrowserCompleteRecoveryCodes_FullMethodName,
