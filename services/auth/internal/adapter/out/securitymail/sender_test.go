...
func TestSecurityNotificationsRenderRealActions(t *testing.T) {
	...
	for _, kind := range []string{"verify", "code", "reset", "change_email", "cancel_email", "new_login", "password_changed", "account_locked", "sessions_closed", "two_factor_on", "two_factor_off", "backup_codes", "cancel_deletion"} {
