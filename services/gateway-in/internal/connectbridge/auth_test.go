...
func TestAuthFixedRoutesAndPrivateContext(t *testing.T) {
	for _, test := range []struct {
		...
		{"StartRecoveryCodes", contractv1.RouteId_ROUTE_ID_AUTH_START_RECOVERY_CODES, &authv1.BrowserStartRecoveryCodesRequest{}, &authv1.BrowserStartRecoveryCodesResponse{Response: &authv1.StartRecoveryCodesResponse{}, SetCookie: []string{"a=secret; Secure", "b=secret; HttpOnly"}}, `{}`},
		...
		{"CompleteRecoveryCodes", contractv1.RouteId_ROUTE_ID_AUTH_COMPLETE_RECOVERY_CODES, &authv1.BrowserCompleteRecoveryCodesRequest{}, &authv1.BrowserCompleteRecoveryCodesResponse{Response: &authv1.CompleteRecoveryCodesResponse{}, SetCookie: []string{"a=secret; Secure", "b=secret; HttpOnly"}}, `{}`},
