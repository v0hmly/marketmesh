...
Ниже сохранён исторический отчёт полного стенда от 21.09. Он не означает,
что AV/CDR/S3/KMS и полный control E2E повторно выполнены 22.09. Исправление
замечаний не закрывает исходные условия принятия ADR, контейнерных CVE и двух-DC
failover. PR остаётся draft до их выполнения.
...
Для интеграции отключённого кода подготовлено
[предложение ограниченной приёмки](../security/files-dev-acceptance.md).
Владелец ещё не согласовал исключение; исходные условия ниже остаются открытыми.
Остаточные CVE Files отслеживает MM-88 (общие PostgreSQL/account образы — MM-67),
полный Files DC E2E — MM-89. Создание этих задач не заменяет проверки.
