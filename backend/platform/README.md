...
- [`mail`](mail/README.md) — рендер 15 транзакционных писем авторизации из встроенных табличных HTML/TXT-шаблонов с типизированными данными и валидацией; только стандартная библиотека.
