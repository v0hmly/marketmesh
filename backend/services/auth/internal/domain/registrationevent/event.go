...
func (e Event) Validate() error {
	if e.ID == ([16]byte{}) || e.SubjectID == (credential.SubjectID{}) || e.OccurredAt.IsZero() || e.OccurredAt.UnixNano() <= 0 || !time.Unix(0, e.OccurredAt.UnixNano()).Equal(e.OccurredAt) || e.OccurredAt.Nanosecond()%1000 != 0 {
